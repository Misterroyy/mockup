...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [
	{
		...
		dataPoints: [
			...
			{ x: new Date(2016, 3), y: 40000},
			{ x: new Date(2016, 4), y: 50000 },
			{ x: new Date(2016, 5), y: 60000 },
			{ x: new Date(2016, 6), y: 70000 },
			{ x: new Date(2016, 7), y: 80000 },
			{ x: new Date(2016, 8), y: 90000 },
			{ x: new Date(2016, 9), y:  100000},
			{ x: new Date(2016, 10), y: 110000 },
			{ x: new Date(2016, 11), y: 120000 , indexLabel: "High Renewals" }
		]
	}, 
	// {
	// 	type: "line",
